...
XVector4DWidget::XVector4DWidget( QWidget *parent, const Eks::Vector4D &val, QStringList labels ) : QWidget( parent ),
...
XVector4DWidget::XVector4DWidget( const Eks::Vector4D &val, const Eks::Vector4D &min, const Eks::Vector4D &max, QStringList labels, QWidget *parent ) : QWidget( parent ),
...
void XVector4DWidget::setMaximum( const Eks::Vector4D &in )
    {
    _x->setMaximum( in.x() );
    _y->setMaximum( in.y() );
    _z->setMaximum( in.z() );
...
Eks::Vector4D XVector4DWidget::maximum() const
    {
    return Eks::Vector4D( _x->maximum(), _y->maximum(), _z->maximum(), _w->maximum() );
    }

void XVector4DWidget::setMinimum( const Eks::Vector4D &in )
    {
    _x->setMinimum( in.x() );
    _y->setMinimum( in.y() );
    _z->setMinimum( in.z() );
...
Eks::Vector4D XVector4DWidget::minimum() const
    {
    return Eks::Vector4D( _x->minimum(), _y->minimum(), _z->minimum(), _w->minimum() );
    }

Eks::Vector4D XVector4DWidget::range() const
    {
    return maximum() - minimum();
    }

Eks::Vector4D XVector4DWidget::value() const
    {
    return Eks::Vector4D( _x->value(), _y->value(), _z->value(), _w->value() );
    }

void XVector4DWidget::setValue( const Eks::Vector4D &in )
    {
    if( !_setting )
        {
        _setting = true;
...
void XVector4DWidget::setValues()
    {
    setValue( Eks::Vector4D( _x->value(), _y->value(), _z->value(), _w->value() ) );
    }
